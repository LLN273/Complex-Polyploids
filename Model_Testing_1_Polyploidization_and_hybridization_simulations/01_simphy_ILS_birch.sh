...
## Simulated phylogenies replicate birch phylogeny
## Includes moderate levels of ILS
## Twenty-five independent replicates were simulated, each containing fifty gene families, producing a grand total of 1,250 gene families
...
# output folder (root)
RR=/crex1/proj/snic2020-6-184/nobackup/private/Luis/P11_SIMULATED_FASTA_PHYLOGENY_HYBRIDIZATION_exomeData/01_simphy_ILS		
...
# General
# 25 replicates (-rs)   [OLD: 25]
# 50 loci (-rl)	[OLD: 1200]
# 1 gene tree per locus (-rg)
# 2 individuals per species (-si)
# Ne=400K (-sp)

# Outfolder for above conditions
OUTF=A_modILS_birch
...
$simphy -rs 25 \
        ...
        -op 1 \
        -od 1 \
        -s '((((LENTA_SIM:35000,ALBOSINENSIS_SIM:35000):40000,(HUMILIS_SIM:35000,PUBESCENS_H:35000):40000):195000,(OCCIDENTALIS_SIM:230000,((NANA_SIM:45000,PUBESCENS_N:45000):145000,(POPULIFOLIA_SIM:150000,(PUBESCENS_ANC:110000,((PLATYPHYLLA_SIM:35000,PUBESCENS_PLA:35000):35000,(PENDULA_SIM:35000,PUBESCENS_PEN:35000):35000):40000):40000):40000):40000):40000):120000,ALNUS_SIM:390000);'
